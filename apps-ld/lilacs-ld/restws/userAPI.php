<?php
require_once(PATH_LILACS_LD."db/userDB.php");
...
function userAPI($request_data){ 
  ...
  if(isset($request_data['api_key'])){
    ...
    response(400, "El parametro 'api_key' es obligatorio. Codigo de 32 caracteres que identifica a un usuario de forma unica en LILACS-ld.");  }
}
...
function generateAPIkey(){
  ...
  do{
    ...
    $api_key = md5($random);
  }while(getCount($link, 'user', "api_key='".$api_key."'"));
